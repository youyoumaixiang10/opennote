...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "Noto Sans CJK SC", cqw: 1.5, weight: 400, lineHeight: 1.5 }
  lead:    { fontFamily: "Noto Sans CJK SC", cqw: 2.08, weight: 400, lineHeight: 1.5 }
  card-title:{ fontFamily: "Noto Sans CJK SC", cqw: 2.3, weight: 500, lineHeight: 1.25, tracking: "-0.005em" }
  button:  { fontFamily: "Noto Sans CJK SC", cqw: 1.46, weight: 500, lineHeight: 1.0 }
  tag-upper:{ fontFamily: "Noto Sans CJK SC", cqw: 1.35, weight: 500, tracking: "0.18em", upper: true }
  kicker:  { fontFamily: "Noto Sans CJK SC", px: 28, cqw: 1.46, weight: 500, tracking: "0.16em", upper: true }
  mono-label:{ fontFamily: "Noto Sans CJK SC", px: 26, cqw: 1.35, weight: 500, tracking: "0.02em" }
  code:    { fontFamily: "Noto Sans CJK SC", cqw: 1.67, weight: 400, lineHeight: 1.6 }
  ...
  headline:{ fontFamily: "Noto Serif CJK SC", cqw: 4.6, weight: 400, lineHeight: 1.06, tracking: "-0.018em" }
  quote-pull:{ fontFamily: "Noto Serif CJK SC", cqw: 5.0, weight: 400, lineHeight: 1.12, tracking: "-0.012em", italic: true }
  display-italic:{ fontFamily: "Noto Serif CJK SC", cqw: 6.7, weight: 400, lineHeight: 1.05, tracking: "-0.012em", italic: true }
  display:{ fontFamily: "Noto Serif CJK SC", cqw: 7.3, weight: 400, lineHeight: 1.02, tracking: "-0.022em" }
  number-hero:{ fontFamily: "Noto Serif CJK SC", cqw: 9.4, weight: 400, lineHeight: 0.95, tracking: "-0.025em" }
  display-cover:{ fontFamily: "Noto Serif CJK SC", cqw: 9.9, weight: 400, lineHeight: 0.98, tracking: "-0.028em" }
  number-unit:{ fontFamily: "Noto Sans CJK SC", cqw: 2.08, weight: 500, lineHeight: 1.0 }
...
## Shipped fonts (THIS project — use these exact @font-face declarations)

All visible text is Chinese/Latin rendered with project-shipped subsets under `assets/fonts/` (relative to project root; from `compositions/frames/*.html` the path is `../../assets/fonts/`). Declare ONLY these families, with @font-face inside your `<template>`:

```css
@font-face { font-family: "Noto Serif CJK SC"; font-weight: 400; src: url("../../assets/fonts/serif-regular.woff2") format("woff2"); }
@font-face { font-family: "Noto Serif CJK SC"; font-weight: 700; src: url("../../assets/fonts/serif-bold.woff2") format("woff2"); }
@font-face { font-family: "Noto Sans CJK SC"; font-weight: 400; src: url("../../assets/fonts/sans-regular.woff2") format("woff2"); }
@font-face { font-family: "Noto Sans CJK SC"; font-weight: 500; src: url("../../assets/fonts/sans-medium.woff2") format("woff2"); }
@font-face { font-family: "Noto Sans CJK SC"; font-weight: 700; src: url("../../assets/fonts/sans-bold.woff2") format("woff2"); }
```

- display role → "Noto Serif CJK SC" (400/700; the subsets cover the storyboard's copy only)
- body / kicker / mono roles → "Noto Sans CJK SC" (kicker keeps its 0.16em tracking + uppercase for Latin)
- Weights above 700 are not shipped — cap display weight at 700.
