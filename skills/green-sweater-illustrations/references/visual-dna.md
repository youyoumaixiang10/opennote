...
像一个长期做 AI、产品、设计、开发工具的人，在白纸上随手画出来的一张解释草图；只是核心动作主体固定为绿毛衣女孩。
...
- 角色要像参考图，但要融入正文配图，不要变成角色设定页。

## 颜色

- 黑色：主体线稿、头发、裤子、框线、结构、主要文字、主体物件。
- 深绿色：角色的高领毛衣，作为 IP 识别色。
